...
GAMfitting <- function(PAlist) { ## start of main function
  for(i in PAlist) {
  ...
  # this is a bit of a 'unelegant' solution, as the names of the objects need to be changed, everytime everytime the number of PA samples is changed in the previous step
